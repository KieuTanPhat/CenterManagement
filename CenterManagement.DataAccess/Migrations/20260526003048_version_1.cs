    ...
    public partial class version_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassTransfers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassTransfers_Classes_FromClassId",
                        column: x => x.FromClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassTransfers_Classes_ToClassId",
                        column: x => x.ToClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassTransfers_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherClassRegistrations", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeacherClassRegistrations_Teachers_TeacherId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Quản lý chuỗi", "SystemAdmin", null },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Quản lý chi nhánh", "BranchManager", null },
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Nhân viên", "Staff", null },
                    { 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Giáo viên", "Teacher", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassTransfers_FromClassId",
                table: "ClassTransfers",
                column: "FromClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassTransfers_StudentId",
                table: "ClassTransfers",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassTransfers_ToClassId",
                table: "ClassTransfers",
                column: "ToClassId");
